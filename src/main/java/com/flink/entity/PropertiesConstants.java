...
public class PropertiesConstants {
    ...
    public static final String DEFAULT_KAFKA_BROKERS = "121.40.30.72:9092,120.55.88.211:9092,121.41.82.205:9092";
    public static final String KAFKA_ZOOKEEPER_CONNECT = "kafka.zookeeper.connect";
    public static final String DEFAULT_KAFKA_ZOOKEEPER_CONNECT = "121.40.30.72:2181,120.55.88.211:2181,121.41.82.205:2181";
    public static final String KAFKA_GROUP_ID = "kafka.group.id";
    public static final String DEFAULT_KAFKA_GROUP_ID = "szp";
