...
import common.schemas.SensorReadingSchema;
...
import static com.flink.entity.PropertiesConstants.*;
...
public class KafkaConfigUtil {
    ...
    public static DataStreamSource<SensorReading> buildSource(StreamExecutionEnvironment env) throws IllegalAccessException {
     ...
     */
    public static DataStreamSource<SensorReading> buildSource(StreamExecutionEnvironment env, String topic, Long time) throws IllegalAccessException {
        ParameterTool parameterTool = (ParameterTool) env.getConfig().getGlobalJobParameters();
        Properties props = buildKafkaProps(parameterTool);
        FlinkKafkaConsumer011<SensorReading> consumer = new FlinkKafkaConsumer011<>(
                topic,
